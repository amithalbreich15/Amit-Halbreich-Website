    ...
    <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
      ...
      <div className="mt-14 text-center">
        ...
        <a
          ...
          className="inline-flex items-center space-x-2 px-5 py-2 text-sm sm:text-base bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition-colors"
        >
          View All Projects on GitHub <Github className="h-5 w-5" />
        </a>
      </div>
    </div>
  );
